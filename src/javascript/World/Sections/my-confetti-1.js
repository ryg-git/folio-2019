...
export var Firework = function (fscene) {
    this.scene = fscene;
    this.done = false;
    this.dest = [];
    this.colors = [];
...
Firework.prototype = {
    ...
    launch: function () {
        ...
        var y = THREE.Math.randInt(1, 8);
        var z = THREE.Math.randInt(-10, -30);

        var from = new THREE.Vector3(x, -8, z);
...
//     camera = new THREE.PerspectiveCamera(60, screen.ratio, 0.1, 2);
...
//       renderer.setClearColor( 0x, 0 );
//       renderer.sortObjects = true;
//       renderer.domElement.style["display"]  = "block";
//       renderer.domElement.style["position"] = "fixed";
//       renderer.domElement.style["width"]    = "1%";
//       renderer.domElement.style["height"]   = "1%";
...
// animation loop
export function draw(mscene) {
    requestAnimationFrame(() => draw(mscene));
    ...
    if (THREE.Math.randInt(1, 20) === 10) {
        fireworks.push(new Firework(mscene));
    }
    // update fireworks
